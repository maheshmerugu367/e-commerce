...
<div class="page-header">
    <h4 class=""> List Sub Categories</h4>
</div>
                    ...
                    <div class="row">
                        <div class="col-sm-3 mb-1 mt-1">
                            <div class="form-group">
                                ...
                                <form action="{{ route('admin.list.subcategories.index') }}" method="GET">
                        ...
                        <div class="col-sm-8  text-end mt-2">
                            <a href="{{route('admin.list.subcategory.create')}}"> <label class="badge badge-success"><i class="mdi  mdi-plus-circle-outline me-1"></i>Add</label></a>
            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <table class="table table-striped ">
                        ...
                        $subcategory_name=App\Models\subCategory::where('id', $category->sub_category_id)->first();
                        ...
                        @endphp
                            ...
                            <td>
                                ...
                                <td class=""> 
                                <a href="{{ route('admin.list.subcategories.edit', ['id' => $category->id]) }}">
...
if (userConfirmed) {
    ...
    axios.post('{{ route("admin.list.subcategory.deleteSelected") }}', {
            ids: selectedIds
        })
        .then(response => {
    ...
    document.getElementById('trashSelected').addEventListener('click', function() {
        ...
        if (trashselectedIds.length > 0) {
            ...
            axios.post('{{ route("admin.list.subcategory.trashSelected") }}', {
    ...
    document.getElementById('activeSelected').addEventListener('click', function() {
        ...
        if (activeselectedIds.length > 0) {
            ...
            axios.post('{{ route("admin.list.subcategory.activeSelected") }}', {
    ...
    document.getElementById('inactiveSelected').addEventListener('click', function() {
        ...
        if (inactiveselectedIds.length > 0) {
            ...
            axios.post('{{ route("admin.list.subcategory.inactiveSelected") }}', {
    ...
    document.getElementById('frontactiveSelected').addEventListener('click', function() {
        ...
        if (frontactiveselectedIds.length > 0) {
            ...
            axios.post('{{ route("admin.list.subcategory.frontactiveSelected") }}', {
    ...
    document.getElementById('frontinactiveSelected').addEventListener('click', function() {
        ...
        if (frontinactiveselectedIds.length > 0) {
            ...
            axios.post('{{ route("admin.list.subcategory.frontinactiveSelected") }}', {
