...
<div class="page-header">
    <h4 class=""> Add List Subcategory </h4> <a href="{{route('admin.list.subcategories.index')}}" class=" "> <label class="badge badge-info"><i class="mdi mdi-apps"></i> Manage</label></a>
</div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body pb-5">
                    ...
                    <form id="uploadForm" action="{{route('admin.list.subcategory.store')}}" class="form-sample" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <option value="">Select</option>
                                        ...
                                        <option value="{{ $category->id }}"
                                            {{ old('category_id', $category) == $category->id ? 'selected' : '' }}>
                                            {{ $category->title }}
                                        </option>
                                        @endforeach                         
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <option value="">Select</option>
                                        ...
                                        <option value="{{ $sub_category->id }}"
                                            {{ old('sub_category_id', $sub_category) == $sub_category->id ? 'selected' : '' }}>
                                            {{ $sub_category->title }}
                                        </option>
