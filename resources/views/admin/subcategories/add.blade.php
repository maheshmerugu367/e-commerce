...
<div class="page-header">
    <h4 class=""> Add Subcategory </h4> <a href="{{route('admin.subcategory.index')}}" class=" "> <label class="badge badge-info"><i class="mdi mdi-apps"></i> Manage</label></a>
</div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body pb-5">
                    ...
                    <form id="uploadForm" action="{{route('admin.subcategory.store')}}" class="form-sample" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="row">
